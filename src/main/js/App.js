...
export class App extends Component {
    constructor() {
        ...
        this.state.uploadAvatar = this.state.baseAvatar;
    }
                    ...
                    <form action="" onSubmit={this.sendForm}>
                        <div className="box-infos">
                            ...
                            <div className="box-infos__right">
                                <label className="field">
                                    <input type="file" accept="image/jpeg,image/png" spellCheck="false" onInput={this.uploadAvatar}/>
                                    <img src={this.state.uploadAvatar} alt=""/>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="box-infos">
                            <div className="box-infos_inline">
                                <label className="field">
                                    <InputMask mask="99.99.9999" type="text" name={'birthday'} placeholder="Дата рождения"/>
                                    <span className={"field__placeholder"}>Дата рождения</span>
                                </label>
                                <label className="field">
                                    <InputMask mask="+7 999 999 9999" type="phone" name={'telephoneNumber'} placeholder="Номер телефона"/>
                        ...
                        <div className="box-infos">
                            ...
                            <div className="box-infos_block">
                                <label className="field">
                                    <input type="text" name={'languages'} placeholder="Языки"/>
